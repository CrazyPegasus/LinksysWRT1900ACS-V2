...
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_buffalo_ls220de is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_buffalo_ls421de is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_ctera_c200-v2 is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_cznic_turris-omnia is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_fortinet_fg-50e is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_globalscale_mirabox is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_iptime_nas1dual is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_kobol_helios4 is not set
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_linksys_wrt1200ac is not set
CONFIG_TARGET_mvebu_cortexa9_DEVICE_linksys_wrt1900acs=y
# CONFIG_TARGET_mvebu_cortexa9_DEVICE_linksys_wrt1900ac-v1 is not set
...
CONFIG_TARGET_PROFILE="DEVICE_linksys_wrt1900acs"
...
CONFIG_PACKAGE_mwlwifi-firmware-88w8864=y
# CONFIG_PACKAGE_mwlwifi-firmware-88w8897 is not set
# CONFIG_PACKAGE_mwlwifi-firmware-88w8964 is not set
# CONFIG_PACKAGE_mwlwifi-firmware-88w8997 is not set
...
# CONFIG_PACKAGE_kmod-leds-turris-omnia is not set
...
# CONFIG_PACKAGE_libiperf3-mt is not set
...
# CONFIG_PACKAGE_luci-i18n-advanced-reboot-lt is not set
# CONFIG_PACKAGE_luci-i18n-advanced-reboot-mr is not set
# CONFIG_PACKAGE_luci-i18n-advanced-reboot-ms is not set
# CONFIG_PACKAGE_luci-i18n-advanced-reboot-nl is not set
...
CONFIG_PACKAGE_luci-i18n-fullconenat-zh-cn=y
...
CONFIG_PACKAGE_luci-i18n-shutdown-zh-cn=y
...
# CONFIG_PACKAGE_modeminfo-serial-meig is not set
...
# CONFIG_PACKAGE_iperf3-mt is not set
# CONFIG_PACKAGE_iperf3-mt-ssl is not set
...
# CONFIG_PACKAGE_mv88e6xxx_dump is not set
